...
class Goal(models.Model):
    ...
    slug = models.CharField(
        ...
        editable=False,
        help_text=(
            "Unique URL path to access this goal. " + "Generated by the system."
        ),
    )
    ...
    created = models.DateTimeField(
        auto_now_add=True,
        help_text=(
            "The date and time this goal was"
    ...
    monthly_target = models.FloatField(
        default=MAX_VALUE,
        choices=CARBON_CHOICES,
    ...
    def get_absolute_url_personal(self, id):
        ...
        path_components = {"pk": id, "slug": self.slug}
...
class Comment(models.Model):
    ...
    goal = models.ForeignKey(
        Goal, on_delete=models.PROTECT, help_text="Goal referred to by the comment."
    )
    headline = models.CharField(
        max_length=cc_settings.LABEL_MAX_LENGTH,
        editable=True,
        help_text=("Main gist of the comment."),
    )
    description = models.TextField(help_text="Full description of comment.")
    last_modified = models.DateTimeField(
        auto_now_add=True,
        help_text=(
            "The date and time this comment" + " was last edited. Auto-generated."
        ),
    )
